...
public class LeadsList extends AppCompatActivity {
    ...
    public static LeadsList leadlist;
    ...
    public void  setRecycler(List list){
        recyclerTransforList=new RecyclerLeadsList(this,list,"lead");
        recyclerTransforList.notifyDataSetChanged();
        recyclerViewOfList.setLayoutManager(new LinearLayoutManager(LeadsList.this));
    ...
    public void getLeadsList(final String userid){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL_PREFIX_DOMAIN+ServiceUrls.URL_LEADS_LIST, new Response.Listener<String>() {
            @RequiresApi(api = Build.VERSION_CODES.KITKAT)
            @Override
